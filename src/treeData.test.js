...
D\t300\talpha`;
  ...
  describe('deleteTable', () => {
    ...
    it('should remove associated color scales when table is deleted', () => {
      ...
      const scale = treeData.getScale(columnId, 'color');
      ...
      expect(treeData.columnScale.color.has(columnId)).not.toBe(true);
    });
  ...
  describe('getScale', () => {
    ...
    it('should return the same scale instance on subsequent calls', () => {
      ...
      const scale1 = treeData.getScale(columnId, 'color');
      const scale2 = treeData.getScale(columnId, 'color');
  ...
  describe('setScale', () => {
    it('should set a custom color scale for a column', () => {
      ...
      treeData.setScale(columnId, 'color', customScale);

      const retrievedScale = treeData.getScale(columnId, 'color');
    ...
    it('should override automatically created scales', () => {
      ...
      const autoScale = treeData.getScale(columnId, 'color');
